    ...
    <div className="animate-fade-in relative z-10 w-full min-h-screen">
      ...
      {regressions.length > 0 && (
        <div className="mb-8 glass border border-accent-red/50 rounded-2xl p-5 flex items-center gap-4 animate-slide-up shadow-[0_0_30px_rgba(239,68,68,0.15)] relative overflow-hidden">
          ...
          <Link href="/dashboard/ota" className="z-10 px-5 py-2.5 rounded-xl bg-accent-red/10 border border-accent-red/30 text-accent-red hover:bg-accent-red hover:text-white transition-all font-bold tracking-wide text-sm shadow-[0_0_15px_rgba(239,68,68,0.4)]">
            Investigate →
          </Link>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/dashboard/features" className="text-sm font-bold text-brand-400 hover:text-brand-300 transition-colors uppercase tracking-widest">
              View Matrix →
            </Link>
          </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {features.map((f, i) => (
                <Link key={f.feature_id} href={`/dashboard/features/${f.feature_id}`}>
        ...
        <div className="space-y-6">
          ...
          <div className="glass-elevated rounded-[2rem] p-6 border border-white/5 relative overflow-hidden">
             ...
             <div className="mt-6 pt-6 border-t border-white/10 relative z-10">
               <Link href="/dashboard/digest" className="block w-full py-3 rounded-xl bg-white/5 border border-white/10 text-center text-sm font-bold text-white hover:bg-white/10 hover:border-white/20 transition-all uppercase tracking-widest">
                 View Full Report
               </Link>
             </div>
          </div>
